...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const movesNote = ' Also give it exactly 2 signature moves inspired by the local culture, history, or geography of ' + city + '. Each move must have a Japanese name that feels local and poetic, a type from this list [火,水,木,雷,雲,土,氷,鉄,念], a power value between 40-100, and 1-2 types it is strong against from the same list. Format moves as: "moves":[{"name":"技名","type":"タイプ","power":60,"strong_against":["タイプ1"]}]';
