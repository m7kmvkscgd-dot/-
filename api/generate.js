...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const baseFormat = '{"name":"katakana monster name","emoji":"single emoji","city":"' + city + '","concept":"concept in Japanese","types":["type1"],"stats":{"hp":100,"atk":50,"def":40,"spd":35},"weatherStrong":["clear","rain"],"weatherWeak":["snow","thunder"],"promptEn":["feature1","feature2","feature3","512x512px square format, slight right-facing three-quarter view, full body visible, standing dynamic pose, soft gradient background NOT transparent, pokemon-style cute chibi character centered taking 70% of image, simple beautiful background with nature or environment elements matching the monster type, Japanese anime RPG game art","color palette and mood"],"lore":"lore in Japanese 2-3 sentences","moves":[{"name":"わざ名","type":"タイプ","weight":"light","power":65,"strong_against":["タイプ1"]}]}';
